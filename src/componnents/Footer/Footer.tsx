...
return (
    <>
    { isMobile ? (
        <div className="na-footer-mobile">
                <div className="na-mobile-sec1">
                ...
                <div className="na-mobile-sec2">
                    <div className="na-mobile-part1">
                    <h4>روابط</h4>
                    <p> الشهادات</p>
                    <p> السياسة</p>
                    </div>
                    <div className="na-mobile-part2">
